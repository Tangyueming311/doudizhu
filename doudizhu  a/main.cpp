...
int main() {
	...
	while (1) {
		if (K_if_player_is_landlord == 1) {
			...
			endgame(b.getHand(), b1.get_Hand(), b2.get_Hand(),1, 0, 0);
			Sleep(1000);
			...
			if (flag == 0) {
				getNum(17, b.getHand(), 3);
				Player_Card_Creat(b.getHand(), 17, 3, K_if_player_is_landlord);
				flag++;
			}
			endgame(b.getHand(), b1.get_Hand(), b2.get_Hand(), 0, 1, 0);
